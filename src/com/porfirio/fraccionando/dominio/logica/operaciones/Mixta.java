...
public abstract class Mixta extends Operacion {
    ...
    protected String latexAgrupacionPrecedencia() {
        ...
        gruposFracciones.add(new ArrayList<>());
     ...
     * de suma y resta.
     * @param operadoresGrupo Es la lista donde se agregaran los operadores de
    ...
    protected Fraccion resultadoMixta() {
        ...
        // Se recorren los grupos para resolver las operaciones
        for (int i = 0; i < gruposFracciones.size(); i++) {
            // Evalua si no hay operadores (no es operacion, sino una fraccion
            // sola)
        ...
        // Se resuelven sumas y restas finales
